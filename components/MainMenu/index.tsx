...
const Index: React.FC<IndexProps> = ({ isMainMenuOpen, navigateTo, currentPage }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 z-40 inset-x-0 mx-auto w-[60vw] h-12 rounded-b-3xl bg-[#5dadec] dark:bg-gray-800 text-white flex items-center justify-center gap-6 shadow-lg">
      <UserIcon
